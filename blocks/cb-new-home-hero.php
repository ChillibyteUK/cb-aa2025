...
<section class="cb_home_hero">
	...
	<div class="cb_home_hero__content container d-flex align-items-center justify-content-center h-100">
		<div class="row">
			...
			<div class="mt-5 col-12 d-flex justify-content-center align-items-center gap-4">
				<?php
				if ( get_field( 'trial_link' ) ) {
